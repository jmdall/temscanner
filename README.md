...
Windows application : https://github.com/jmdall/temscanner/releases/download/0.9/main.exe
...
2. Scan** your temtem using the scanner (.exe file, only for Windows)
3. Login

** Free users can only see 10 temtem.
